...
* **Payment Provider Integration**: Developed and maintained payment services for a platform with over **2 million users**, integrating multiple **Payment Service Providers (PSPs)**.
...
* **Custom User Logic**: Developed backend rules to handle complex user flows (disabled customers, orgnanizational customers) and engineered resilient logic for **payments and refunds**.

#### User Analytics & Recommender Engine
* **Automated User Journeys**: Developed and maintained a targeted recommendation system optimized for **A/B testing** and **marketing**, powered by **FastAPI**, **ClickHouse**, **RabbitMQ** and **Redis**.
...
* Designed a powerful backend for a competition event managed by Kapa named *Tahe-Nakh* involving at least **160 players in every match**. 
